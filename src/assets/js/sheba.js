...
function iso13616Prepare(input) {
    let iban = input;
...
function iso7064Mod97_10(input) {
    var remainder = input,
        block;
...
function ConvertNumberP2E(StrWithNumber) {
    ...
    do {
        var StrWithNumber2 = StrWithNumber;
        for (var i = 0; i < 10; i++) {
...
export { iso13616Prepare, iso7064Mod97_10, ConvertNumberP2E, getBankFromShaba, getBankFromCard, validateCard }
